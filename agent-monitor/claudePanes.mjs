// Which Claude Code session is running in which terminal window (by pane id). Claude Code
...
// "perch-view-beb4b335:@0.%0" -> "%0". Null for a CLI started outside
...
// paneId -> { sessionId, cwd, updatedAt } for every live Claude CLI that recorded a pane id.
