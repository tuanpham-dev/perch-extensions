// Touch long-press, used to begin a selection and to open a row's menu.
// Copied verbatim from Perch core's client/src/hooks/useLongPressMenu.ts
// (via its extensions/_shared copy) - see useMarqueeSelection.ts's header
// and agentTarget.ts's for why these are copies, not shared imports.
