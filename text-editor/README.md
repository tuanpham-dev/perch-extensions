...
conflict the app would have opened in a terminal window opens here instead. Leave nvim selected and
...
This is a tab's advantage over a terminal window: nvim has nowhere to put such a button, so the
