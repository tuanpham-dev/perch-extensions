...
This replaces the memory reading that used to be built into Perch's status bar. Like any status bar item, it can be dragged to reorder it or move it to the other end of the bar.
