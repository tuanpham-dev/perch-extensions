// Copied from the claude-viewer extension's src/chunks/highlight.ts, which
// is this repo's established way to highlight code: extensions can't import
// each other, so the chunk is duplicated rather than shared (same rule as
// injectStylesheet.ts and clipboard.ts).
//
