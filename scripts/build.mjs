...
// react-jsx-runtime/@perch/engine-support are aliased to scripts/shims/*
...
// Perch's own extensions/build.mjs.
//
...
const shims = {
  ...
  "@perch/engine-support": path.join(scriptsDir, "shims/engine-support.mjs"),
